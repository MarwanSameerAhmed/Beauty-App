...
class ProductCarousel extends StatefulWidget {
  ...
  const ProductCarousel({super.key, this.carouselAds});
...
class _ProductCarouselState extends State<ProductCarousel> {
  ...
  Widget build(BuildContext context) {
    ...
    // إذا ما فيه بيانات، عرض الشيمر
    if (widget.carouselAds == null) {
      return const CarouselShimmer();
    }

    // فلترة البانرات الظاهرة فقط وترتيبها
    final visibleCarouselAds = widget.carouselAds!
