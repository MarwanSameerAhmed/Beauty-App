...
class AuthService {
  ...
  /// Returns the SHA256 hash of the input as a hex string
  ...
  Future<Object?> signInWithApple() async {
    try {
      ...
      AppLogger.error('Apple Sign-In Authorization Error', tag: 'AUTH', error: e);
      if (e.code == AuthorizationErrorCode.canceled) {
        return 'تم إلغاء تسجيل الدخول.';
      }
      return 'فشل تسجيل الدخول بـ Apple: ${e.message}';
    } on FirebaseAuthException catch (e) {
      AppLogger.error('Firebase Auth Error', tag: 'AUTH', error: e);
      return e.message ?? 'فشل تسجيل الدخول بـ Apple.';
    } catch (e) {
      AppLogger.error('Apple Sign-In Error', tag: 'AUTH', error: e);
      return 'حدث خطأ غير متوقع. يرجى المحاولة مرة أخرى.';
    }
  }
